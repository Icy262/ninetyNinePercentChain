...
class BlockFile {
    public static Block readBlock(int blockNum) {
        FileInputStream blockFile=new FileInputStream("./"+String.valueOf(blockNum)+".ser");
    ...
    public static void writeBlock(Block toWrite) {
        FileOutputStream blockFile=new FileOutputStream("./"+String.valueOf(toWrite.index)+".ser");
